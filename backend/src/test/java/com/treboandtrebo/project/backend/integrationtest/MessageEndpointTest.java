package com.treboandtrebo.project.backend.integrationtest;

import com.treboandtrebo.project.backend.basetest.TestData;
import com.treboandtrebo.project.backend.config.properties.SecurityProperties;
import com.treboandtrebo.project.backend.endpoint.dto.DetailedMessageDto;
import com.treboandtrebo.project.backend.endpoint.dto.MessageInquiryDto;
import com.treboandtrebo.project.backend.endpoint.dto.SimpleMessageDto;
import com.treboandtrebo.project.backend.endpoint.mapper.MessageMapper;
import com.treboandtrebo.project.backend.entity.Message;
import com.treboandtrebo.project.backend.repository.MessageRepository;
import com.treboandtrebo.project.backend.security.JwtTokenizer;
...
public class MessageEndpointTest implements TestData {
    ...
    public void givenOneMessage_whenFindById_thenMessageWithAllProperties() throws Exception {
        ...
        Assertions.assertEquals(message, messageMapper.detailedMessageDtoToMessage(detailedMessageDto));
    }
    ...
    public void givenNothing_whenPost_thenMessageWithAllSetPropertiesPlusIdAndPublishedDate() throws Exception {
        ...
        Assertions.assertEquals(message, messageMapper.detailedMessageDtoToMessage(messageResponse));
    }
